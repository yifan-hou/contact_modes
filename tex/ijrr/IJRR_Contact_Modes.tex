...
\runninghead{Huang and Mason}

\title{Fast Dynamically Feasible Contact Mode Enumeration}

\author{Eric Huang\affilnum{1} and Matthew T. Mason\affilnum{1}}

\affiliation{\affilnum{1}Robotics Institute, Carnegie Mellon University}
% \affilnum{2}SAGE Publications Ltd, UK}

\corrauth{Eric Huang}

\email{erich1@andrew.cmu.edu}
