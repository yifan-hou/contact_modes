    ...
    for (int k = 0; k < d + 1; k++) {
        ...
        for (int i = 0; i < n_Lk; i++) {
            ...
            switch (g->_color) {
                ...
                std::vector<int> g_a_subfaces = {f->_id};
                g_b->subfaces = {f->_id};
